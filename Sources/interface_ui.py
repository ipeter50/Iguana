...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.listWidget, 5, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self.precision, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.matrice, 7, 3, 1, 1)
        ...
        self.nomFichier = QtWidgets.QLabel(self.tab_5)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_10.setText(_translate("Form", "<html><head/><body><p align=\"right\">Précision :</p></body></html>"))
        self.train.setText(_translate("Form", "Train"))
        self.precision.setText(_translate("Form", "..."))
        self.matrice.setText(_translate("Form", "..."))
        ...
        self.nomFichier.setText(_translate("Form", "fichier..."))
