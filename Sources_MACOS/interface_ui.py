...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_17.setText(_translate("Form", "Fichier CSV des composants :"))
        ...
        self.chercheFichier.setWhatsThis(_translate("Form", "Correspond au fichier .csv permettant à l\'algorithme de machine learning d\'apprendre. Ce fichier doit spécifier le résultat attendu pour chaque patient."))
